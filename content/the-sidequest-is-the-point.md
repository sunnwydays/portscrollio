...
1. I wanted to have a lasting positive impact on my community
2. If I got started on something, I'd dive deep into it and I'd want to win
...
Step-by-step, no excuse. You know how to do each of these, I hope I've broken
down the barriers for you.

[Super quick youtube tutorial by flyjuggler](https://www.youtube.com/shorts/trKLrl6y_Vc)

Otherwise only 2 steps: 

1. Grab 2 round objects (e.g. balled-up socks)
2. Toss one ball upward, should land on the other hand
3. While the first ball is in the air, throw the second ball upward, toward the other hand
4. Catch
