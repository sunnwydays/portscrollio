...
export function ClosedCaptionIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M19 4H5C3.343 4 2 5.343 2 7v10c0 1.657 1.343 3 3 3h14c1.657 0 3-1.343 3-3V7c0-1.657-1.343-3-3-3zm-9.5 11A3.5 3.5 0 0 1 6 11.5a3.5 3.5 0 0 1 3.5-3.5c1.1 0 2.076.511 2.714 1.303l-1.246.928A1.75 1.75 0 0 0 9.5 9.75a1.75 1.75 0 0 0 0 3.5c.568 0 1.071-.272 1.384-.693l1.247.928A3.483 3.483 0 0 1 9.5 15zm8 0A3.5 3.5 0 0 1 14 11.5a3.5 3.5 0 0 1 3.5-3.5c1.1 0 2.076.511 2.714 1.303l-1.246.928A1.75 1.75 0 0 0 17.5 9.75a1.75 1.75 0 0 0 0 3.5c.568 0 1.071-.272 1.384-.693l1.247.928A3.483 3.483 0 0 1 17.5 15z" />
    </svg>
  );
}
