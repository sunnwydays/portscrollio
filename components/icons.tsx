...
export function GitCommitIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 12m-3 0a3 3 0 1 0 6 0 3 3 0 1 0-6 0M12 9V3M12 15v6" />
    </svg>
  );
}
...
export function DumbbellIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
      <path d="M6.75 7.5h10.5M6.75 12h10.5M6.75 16.5h10.5M4.5 6a1.5 1.5 0 0 0-1.5 1.5v9A1.5 1.5 0 0 0 4.5 18h.75V6H4.5Zm14.25 0h-.75v12h.75a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 18.75 6Z" />
    </svg>
  );
}
